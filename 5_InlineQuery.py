from telegram import Update, ChatAction, InlineKeyboardMarkup, InlineKeyboardButton, InlineQueryResultPhoto
...
#Inline Query
def inline_meme_request(update: Update, callback_context: CallbackContext) -> None:
    
    queryResults = [InlineQueryResultPhoto(str(i), meme, meme) for i, meme in enumerate(memes)]        
...
def main() -> None:
    ...
    dispatcher.add_handler(InlineQueryHandler(inline_meme_request))
